...
<div class="mb-3">
    ...
    <select name="category_id" id="name" @class([ 'form-control p-1' , 'is-invalid'=> $errors->has('category_id'),
        ])>
...
<div class="mb-3">
    ...
    <input type="text" name="price" @class(['form-control', 'is-invalid'=> $errors->has('price')]) value="{{
    $product->price }}" />
    @error('price')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
...
<div class="mb-3">
    ...
    <input type="text" name="compare_price" @class(['form-control', 'is-invalid'=> $errors->has('compare_price')]) value="{{
    $product->price }}" />
    @error('compare_price')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
